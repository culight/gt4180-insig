...
/**
 * Helps construct an initalized {@link android.speech.tts.TextToSpeech} using the
...
public class TextToSpeechInitializerByAction
{
    ...
    /**
     * creates by checking {@link android.speech.tts.TextToSpeech#isLanguageAvailable(java.util.Locale)}
     */
    ...
    /**
     * version of the constructor that converts the {@link java.util.Locale}
     ...
     * {@link android.speech.tts.TextToSpeech.Engine#EXTRA_CHECK_VOICE_DATA_FOR}
     */
     ...
     * {@link #startDataCheck(android.app.Activity, String)}
     */
