        ...
        RecognitionListener
{
     ...
     * {@link #recognize(android.content.Intent)} will not work
     */
    abstract protected void speechNotAvailable();

    /**
     * called when {@link android.speech.SpeechRecognizer} cannot be used on this device and
     * {@link #recognizeDirectly(android.content.Intent)} will not work
     */
